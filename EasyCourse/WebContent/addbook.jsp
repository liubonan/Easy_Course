...
<div class="container_12">
    ...
    <div class="container_content">
        ...
        <div class="formcontainer">
        	<h3 class="text_red">Add a new book</h3>
            <div class="blank20"></div>
        	<form class="general_form" action="/EasyCourse/AddBookServlet" method="get" id="addbookForm">
            	<fieldset>
                	<label for="isbn">ISBN</label>
                    <input type="text" class="general_text validate[required,custom[isbn]] text-input" name="isbn" id="isbn"/>
                    <p class="general_help"></p>
                </fieldset>
            	<fieldset>
                	<label for="title">Title</label>
                    <input type="text" class="general_text validate[required]" name="title" id="title" />
                    <p class="general_help"></p>
                </fieldset>
                <fieldset>
                	<label for="author">Author</label>
                    <input type="text" class="general_text" name="author" />
                    <p class="general_help"></p>
                </fieldset>
                <fieldset>
                	<label for="publisher">Publisher</label>
                    <input type="text" class="general_text" name="pulisher" />
                    <p class="general_help"></p>
                </fieldset>
                <fieldset>
                	<label for="price">Price</label>
                    <input type="text" class="general_text validate[custom[price]] text-input" name="price" id="price"/>
                    <p class="general_help"></p>
                </fieldset>
                <fieldset>

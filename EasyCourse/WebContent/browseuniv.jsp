...
List<University> univ_list = (List<University>)session.getAttribute("univs");
WebHelper wh =new WebHelper();%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Browse University</title>
    ...
    <div class="blank30"></div>
        <div class="grid_620 min_600">
            <div class="img_grid_left">
                ...
                <%int size_y=(int)univ_list.size()/6; %>
                <%int remainder=univ_list.size()%6; %>
                <%for (int j=0;j<size_y;j++){ %>
                <ol class="img_grid">
                	<%for(int i = 0;i < 6;i++){ %>
                	<li>
                		<div class="img_grid_container">
                    	<a href="/EasyCourse/UniversityServlet?univid=<%=univ_list.get(j*6+i).getUnivid()%>"><img src="images/univ.jpg"/></a>
                    	</div>
                    	<div class="blank5"></div>
                        <p><a href="/EasyCourse/UniversityServlet?univid=<%=univ_list.get(j*6+i).getUnivid()%>"><%=univ_list.get(j*6+i).getUnivname() %></a></p>
                    </li>   
                    <%} %>                 
                </ol>
                <div class="blank10"></div>
                ...
                <ol class="img_grid">
                	...
                	<li>
                		<div class="img_grid_container">
                    	<a href="/EasyCourse/UniversityServlet?univid=<%=univ_list.get(size_y*6+i).getUnivid()%>"><img src="images/univ.jpg"/></a>
                    	</div>
                    	<div class="blank5"></div>
                        <p><a href="/EasyCourse/UniversityServlet?univid=<%=univ_list.get(size_y*6+i).getUnivid()%>"><%=univ_list.get(size_y*6+i).getUnivname() %></a></p>
                    </li>   
                	<%} %>
                </ol>
                <%} %>  
                <%}else{ %>
                <h3>There is no universities now.</h3>
                <%} %>
            </div>
            <div class="blank30"></div>
        </div>
        <div class="grid_300">
        	...
        	<div class="blank20"></div>
        	 <p class="link_blue">+&nbsp;<a href="adduniversity.jsp">add new university</a></p>
        </div>
        <div class="blank30"></div>
    </div>
